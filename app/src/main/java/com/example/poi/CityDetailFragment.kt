 ...
 * Use the [CityDetailFragment.newInstance] factory method to
...
class CityDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.nombreciudad).apply {
            text = param1
        }

        view.findViewById<TextView>(R.id.datosgenmed).apply {
            text = param2
        }
